"""
 3. Crie as classes Televisao com atributo status, volume, canal e ControleRemoto com o atributo
  televisao, de forma que:
 a) Devemos poder ligar, desligar e gerenciar som e canais tanto pela televisão quanto via controle
  remoto;
...
class Televisao:
    ...
    def aumentar_canal(self) -> None:
        ...
        print(f'Volume da TV: {self.canal}')
    ...
    def mudar_canal(self, canal: int) -> None:
        self.canal = canal
        print(f'Canala da TV ?: {self.canal}')
